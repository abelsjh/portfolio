...
const MILESTONES = [
  ...
  },
  {
    ...
    tags: ["attendance system", "e-office", "face recognition", "approval workflows"],
    handwriting: "~ presensi & face recognition",
    noteLabel: "DEPLOYMENT NOTE",
    note: "Hybrid RFID + face recognition check-in live. E-office approval flow shipped to production.",
    pathX: 72,
    nodeY: 938,
    cardSide: "right" as const,
    cardTop: 910,
