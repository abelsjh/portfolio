  ...
  return (
    <>
      <motion.section
        ...
        className="relative min-h-screen flex flex-col items-center justify-center px-6 md:px-12 bg-bg overflow-hidden"
      >
        ...
        {/* CTA Content — truly centered, no footer competing */}
        <div className="max-w-3xl mx-auto text-center flex flex-col items-center gap-8 relative z-10">
          ...
          <button
            ...
            className="min-w-[200px] px-8 py-4 bg-accent text-bg font-semibold rounded-full hover:translate-y-[-2px] transition-all duration-300 shadow-md hover:shadow-accent/25 flex items-center justify-center gap-2 text-sm cursor-pointer overflow-hidden relative"
          >
